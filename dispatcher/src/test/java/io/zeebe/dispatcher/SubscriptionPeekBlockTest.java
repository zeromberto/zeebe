...
//  static final int A_FRAGMENT_LENGTH = align(A_MSG_PAYLOAD_LENGTH + HEADER_LENGTH,
// FRAME_ALIGNMENT);
...
//    logBufferPartition =
//        new LogBufferPartition(dataBufferMock, metadataBufferMock,
// A_PARTITION_DATA_SECTION_OFFSET);
//
...
//    verify(subscriberPositionMock)
//        .proposeMaxOrdered(position(nextPartionId, nextFragOffset)); // is secondFragOffset
// somehow
//  }
//
//  @Test
...
//    // and the position was rolled over to the next fragement after the padding
//    verify(subscriberPositionMock)
//        .proposeMaxOrdered(position(A_PARTITION_ID, nextFragOffset)); // is secondFragOffset
// somehow
//  }
//
//  @Test
